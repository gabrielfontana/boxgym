...
public final class Constant {
    ...
    public static final String PATH_SUPPLIERS_ADD_VIEW = "/boxgym/view/SuppliersAddScreen.fxml";
    ...
    public static final String TITLE_SUPPLIERS_ADD = "Adicionando Fornecedor";
    ...
    public static final String[] LIST_FEDERATIVE_UNITS = {"AC", "AL", "AP", "AM", "BA", "CE",
                                                          "DF", "ES", "GO", "MA", "MT", "MS",
                                                          "MG", "PA", "PB", "PR", "PE", "PI",
                                                          "RJ", "RN", "RS", "RO", "RR", "SC",
                                                          "SP", "SE", "TO"};
